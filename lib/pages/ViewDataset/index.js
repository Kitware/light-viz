...
export default React.createClass({
    ...
    render() {
        ...
        const independentPanels = ['time', 'colormap', 'fgbg'];

        return (<div className={ style.viewDataset }>
                  <div className={ style.titleBar }>
                    ...
                    <div className={ style.colorControls }>
                      ...
                      <ColorMap onChange={ setColorMap } location={ this.props.location }/>
                      <FGBG location={this.props.location}/>
                    </div>
                  </div>
                  <div className={ style.leftSidebar }>
                    <div className={ style.modules }>
                      { modules.map( panel => {
                        return <Module key={ panel.name } panel={ panel } { ...this.props } dataset={ this.state.dataset } freePanels={independentPanels}/>
                      })};
                    </div>
                  ...
                  <VtkRenderer className={ style.vtkRenderer } connection={ getConnection() } client={ getClient() }/>
                </div>);
    },
});
