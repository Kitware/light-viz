        ...
        return (<div className={ style.viewDataset }>
                  <div className={ style.titleBar }>
                    ...
                    <div className={ style.colorControls }>
                      ...
                      <ColorMap className={ style.colorControl } onChange={ setColorMap } location={ this.props.location }/>
                      <FGBG className={ style.colorControl } location={this.props.location}/>
                    </div>
                  </div>
                  <div className={ style.leftSidebar }>
                    <div className={ style.modules }>
                      { modules.map( panel => {
                        return <Module className={ style.module }
                                       key={ panel.name }
                                       panel={ panel }
                                       { ...this.props }
