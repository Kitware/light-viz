...
export default React.createClass({
    ...
    render() {
      ...
      const inputSelector = (
          <select className={style.inputSelector} value={this.state.inputValue} onChange={ this.updateInputTo }>
            <option key="Data" value="Data">Data</option>
            <option key="Clip" value="Clip">Clip</option>
          </select>
          );
      const enableApply = (this.oldState.inputValue && !(this.state.inputValue === this.oldState.inputValue))
                       || this.props.needsApply;
      const applyButton = <i className={enableApply ? style.applyButton : style.applyButtonDisabled} onClick={ this.doApply }/>;
      const resetButton = <i className={enableApply ? style.refreshButton : style.refreshButtonDisabled} onClick={ this.doReset }/>;
      return (
