...
export default React.createClass({
    ...
    render() {
        return (<ModulePanel name='clip' dataset={this.props.dataset} moduleName='Clip'>
                    <div className='ClipPanel_line'>
                        <ToggleButton
                            alwaysOn
                            value={ this.state.xInsideOut }
                            icon={'fa-toggle-' + (this.state.xInsideOut ? 'on' : 'off')}
                            name='xInsideOut'
                    ...
                    <div className='ClipPanel_line'>
                        <ToggleButton
                            ...
                            icon={'fa-toggle-' + (this.state.yInsideOut ? 'on' : 'off')}
                            name='yInsideOut'
                            onChange={ this.toggleInsideOut }
                            style={{width: '30px'}}/>
                        <DoubleSliderElement
                    ...
                    <div className='ClipPanel_line'>
                        <ToggleButton
                            ...
                            icon={'fa-toggle-' + (this.state.zInsideOut ? 'on' : 'off')}
                            name='zInsideOut'
                            onChange={ this.toggleInsideOut }
                            style={{width: '30px'}}/>
                        <DoubleSliderElement
