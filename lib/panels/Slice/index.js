...
export default React.createClass({
  ...
  getInitialState() {
    this.oldState = {
      xPosition:
        (this.props.dataset.data.bounds[0] +
          this.props.dataset.data.bounds[1]) *
        0.5,
      yPosition:
        (this.props.dataset.data.bounds[2] +
          this.props.dataset.data.bounds[3]) *
        0.5,
      zPosition:
        (this.props.dataset.data.bounds[4] +
          this.props.dataset.data.bounds[5]) *
        0.5,
      xVisible: true,
      yVisible: true,
      zVisible: true,
  ...
  componentDidMount() {
    getState('slice', this, this.modulePanel);
  },
      ...
      >
        <div className={style.line}>
          <ToggleButton
            ...
            icon={
              this.state.xVisible ? style.toggleOnIcon : style.toggleOffIcon
            }
            name="xVisible"
        ...
        <div className={style.line}>
          <ToggleButton
            ...
            icon={
              this.state.yVisible ? style.toggleOnIcon : style.toggleOffIcon
            }
            name="yVisible"
            onChange={this.toggleSliceVisible}
            style={{ width: '30px' }}
        ...
        <div className={style.line}>
          <ToggleButton
            ...
            icon={
              this.state.zVisible ? style.toggleOnIcon : style.toggleOffIcon
            }
            name="zVisible"
            onChange={this.toggleSliceVisible}
            style={{ width: '30px' }}
