...
const VCR_CONTROL = [
    { icon: style.goToBeginningButton, delta: -1000000},
    { icon: style.stepBackButton, delta: -1},
    { icon: style.playButton, action: 'play'},
    { icon: style.stopButton, action: 'stop'},
    { icon: style.stepForwardButton, delta: +1},
    { icon: style.goToEndButton, delta: +10000000},
];
...
export default React.createClass({
    ...
    render() {
        return (<div className={ this.playing ? style.timePanelPlaying : style.timePanel }>
