...
export default class ForegroundBackground extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    this.updateForeground = this.updateForeground.bind(this);
  }
...
ForegroundBackground.propTypes = {
  className: PropTypes.string,
  freePanels: PropTypes.array,
  location: PropTypes.object,
};

ForegroundBackground.defaultProps = {
  className: '',
